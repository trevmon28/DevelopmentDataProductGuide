...
* Gemma is [Google's Open LLM](https://huggingface.co/blog/gemma)
...
* LinkTransformer is a [unified package for record linkage](https://arxiv.org/abs/2309.00789)
...
* Jina is an open source [text embedding model](https://jina.ai/news/jina-ai-launches-worlds-first-open-source-8k-text-embedding-rivaling-openai/)
...
* Inception platform is a [semantic annotation and knowldge management tool](https://inception-project.github.io/)
...
* The Pile is a [web data set for training text models](https://pile.eleuther.ai/paper.pdf)
* LAION-5B is an [open image-text data set](https://laion.ai/blog/laion-5b/)
* T5 is a [text transformer unified model](https://huggingface.co/docs/transformers/model_doc/t5)
